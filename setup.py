...
PACKAGEDATA = {
    ...
    'package_dir': {'OneWayTrip': 'OneWayTrip',
                   },
    'packages': ['OneWayTrip',
                ],
    'scripts': ['scripts/OneWayTrip'],
}
...
_DATA_DIR = os.path.join('OneWayTrip', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'OneWayTrip': data_dirs}
...
src = []
add_files(src,os.walk('OneWayTrip'))
